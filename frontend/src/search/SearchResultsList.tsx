        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {results.people.map(person => (
              <Link key={person.uuid} to={`/profile/${person.uuid}`}>
                <Card hover>
                  <Card.Body>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {results.projects.map(project => (
              <Link key={project.uuid} to={`/projects/${project.uuid}`}>
                <Card hover>
                  <Card.Body>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {results.teams.map(team => (
              <Link key={team.uuid} to={`/teams/${team.uuid}`}>
                <Card hover>
                  <Card.Body>
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <Badge variant="forest" size="sm" className="mb-1">
                          {team.category}
                        </Badge>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {results.schools.map(school => (
              <Link key={school.uuid} to={`/schools/${school.uuid}`}>
                <Card hover>
                  <Card.Body>
                    <div className="flex items-center gap-4">
                      {school.logoUrl ? (
