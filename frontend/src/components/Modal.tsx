          ...
          {title && (
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200 flex-shrink-0">
              ...
              <button
                onClick={onClose}
                aria-label="Close"
                className="-mr-2 inline-flex h-10 w-10 items-center justify-center text-gray-400 hover:text-gray-600 rounded-lg hover:bg-gray-100 [transition:background-color_120ms,color_120ms,transform_120ms] active:scale-[0.96]"
              >
