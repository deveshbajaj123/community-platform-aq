...
export const SAMPLE_AUTHORS: Record<string, SampleAuthor> = {
  'priyasha-uuid': { uuid: 'priyasha-uuid', fullName: 'Priyasha Chatterjee', school: 'South Point High School', classGrade: 'Class 11', role: 'member', bio: 'Welfare team. I show up every weekend. Mainly for the dogs.', dept: 'welfare' },
  'arjun-uuid':    { uuid: 'arjun-uuid',    fullName: 'Arjun Mehta',          school: 'La Martiniere for Boys',  classGrade: 'Class 12', role: 'director', bio: 'Events Director @ AquaTerra. Reverie 2024 lead. Making noise for four years.', dept: 'events' },
  'ishaan-uuid':   { uuid: 'ishaan-uuid',   fullName: 'Ishaan Roy',            school: 'Heritage School Kolkata', classGrade: 'Class 11', role: 'member', bio: 'AQ Tech — building tools for people who do real things.', dept: 'labs' },
  'ananya-uuid':   { uuid: 'ananya-uuid',   fullName: 'Ananya Sen',            school: 'Loreto House',            classGrade: 'Class 12', role: 'director', bio: 'Welfare Director. 8 medical camps this year. Target was 10. We\'re hitting 12.', dept: 'welfare' },
  'rhea-uuid':     { uuid: 'rhea-uuid',     fullName: 'Rhea Bose',             school: 'Modern High School',      classGrade: 'Class 10', role: 'member', bio: 'Prism Media — I document what the welfare team does and try not to cry.', dept: 'content' },
  'kabir-uuid':    { uuid: 'kabir-uuid',    fullName: 'Kabir Dasgupta',        school: 'DPS Ruby Park',           classGrade: 'Class 12', role: 'director', bio: 'Operations Director. Batch approvals, logistics, the stuff nobody sees.', dept: 'operations' },
  'tanya-uuid':    { uuid: 'tanya-uuid',    fullName: 'Tanya Agarwal',         school: 'Calcutta International School', classGrade: 'Class 11', role: 'member', bio: 'Plantation drives and welfare. 4,200+ saplings since 2022 — still counting.', dept: 'welfare' },
  'soham-uuid':    { uuid: 'soham-uuid',    fullName: 'Soham Bhadra',          school: "St. Xavier's Collegiate School", classGrade: 'Class 10', role: 'member', bio: 'Events team. Workshop facilitator at Pather Sathi. I get nervous every time.', dept: 'events' },
  'devansh-uuid':  { uuid: 'devansh-uuid',  fullName: 'Devansh Saha',          school: 'The Newtown School',      classGrade: 'Class 12', role: 'member', bio: 'Relief operations and welfare. Sundarbans trip changed how I think about outreach.', dept: 'welfare' },
  'priya-uuid':    { uuid: 'priya-uuid',    fullName: 'Priya Ghosh',           school: 'Mahadevi Birla World Academy', classGrade: 'Class 11', role: 'member', bio: 'Events team. Fundraiser specialist. I make spreadsheets no one reads.', dept: 'events' },
}

export const SAMPLE_POSTS: SamplePost[] = [
  {
    postId: 9001, uuid: 'sample-post-1',
    authorName: 'Priyasha Chatterjee', authorUuid: 'priyasha-uuid', authorSchool: 'South Point High School',
...
Team: Arjun, Sneha, Rohan, Tanya, me. Next drive is next Saturday, same spot, 7:30am. Tag anyone who wants to join.`,
  },
  {
    ...
    authorName: 'Arjun Mehta', authorUuid: 'arjun-uuid', authorSchool: 'La Martiniere for Boys',
...
Thank you to everyone on the Events team who didn't sleep for three days. You know who you are.`,
  },
  {
    ...
    authorName: 'Ishaan Roy', authorUuid: 'ishaan-uuid', authorSchool: 'Heritage School Kolkata',
...
If you're on the Labs team and want to help with the backend, ping me. We're using Node + Postgres and it's nothing fancy.`,
  },
  {
    ...
    authorName: 'Ananya Sen', authorUuid: 'ananya-uuid', authorSchool: 'Loreto House',
...
If anyone has contacts at other vet clinics who might want to partner, please reach out. We can't scale this without more medical professionals who believe in what we're doing.`,
  },
  {
    ...
    authorName: 'Rhea Bose', authorUuid: 'rhea-uuid', authorSchool: 'Modern High School',
...
Prism Media is also looking for photographers for the next welfare drive. You don't need experience — just show up with a phone and a willingness to get your shoes dirty.`,
  },
  {
    ...
    authorName: 'Kabir Dasgupta', authorUuid: 'kabir-uuid', authorSchool: 'DPS Ruby Park',
...
Retention from last batch was 78%. That's our highest yet.`,
  },
  {
    ...
    authorName: 'Tanya Agarwal', authorUuid: 'tanya-uuid', authorSchool: 'Calcutta International School',
...
Total: 4,200+ saplings planted since 2022. Running count is on the website.`,
  },
  {
    ...
    authorName: 'Soham Bhadra', authorUuid: 'soham-uuid', authorSchool: "St. Xavier's Collegiate School",
...
This is our third session at this school. The principal asked if we could run one every month. We said yes. If you want to facilitate, DM me.`,
  },
  {
    ...
    authorName: 'Devansh Saha', authorUuid: 'devansh-uuid', authorSchool: 'The Newtown School',
...
Full trip report going on Prism Media this week.`,
  },
  {
    ...
    authorName: 'Priya Ghosh', authorUuid: 'priya-uuid', authorSchool: 'Mahadevi Birla World Academy',
...
export function applySampleLikes(posts: SamplePost[]): SamplePost[] {
  ...
  return posts.map(p => {
    ...
    if (saved) return { ...p, isLiked: saved.liked, likeCount: saved.count }
    return p
  })
}
