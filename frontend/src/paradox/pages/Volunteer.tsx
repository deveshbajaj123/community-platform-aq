...
const DAYS = ['Jun 2', 'Jun 3', 'Jun 4', 'Jun 5', 'Jun 6', 'Jun 7', 'Jun 8']
    ...
    <div className="mb-3.5">
      ...
      <input
        ...
        className={`w-full px-3.5 py-3.5 min-h-[48px] font-body text-[16px] text-ink bg-transparent border-[1.5px] outline-none transition-[border-color,box-shadow] duration-150 placeholder:text-ink/40 focus:ring-2 focus:ring-[var(--c1)] focus:outline-none ${
          showErr ? 'border-c1 shadow-[3px_3px_0_#FF4338]' : 'border-ink/40 focus:border-ink focus:shadow-[3px_3px_0_#181818]'
        }`}
      />
    </div>
  )
  ...
  return (
    <div className="mb-3.5">
      ...
      <textarea
        ...
        onChange={(e) => onChange(e.target.value)}
        placeholder={placeholder}
        className="w-full px-3.5 py-3.5 min-h-[120px] font-body text-[16px] text-ink bg-transparent border-[1.5px] border-ink/40 outline-none focus:border-ink focus:ring-2 focus:ring-[var(--c1)] focus:outline-none placeholder:text-ink/40 resize-none transition-[border-color,box-shadow]"
      />
    </div>
  )
}
...
export function VolunteerPage() {
  ...
  async function submit() {
    ...
    try {
      ...
      success('Application received!', "We'll reach out before Jun 3")
      setStep('success')
    } finally {
      setSubmitting(false)
    }
                ...
                {ROLES.map((r) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={`text-left bg-bg border-[1.5px] border-ink p-4 min-h-[48px] transition-[transform,box-shadow,background-color,color] duration-150 hover:scale-[1.02] ${
