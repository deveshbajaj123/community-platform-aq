    ...
    return (
      <div className="min-h-[100dvh] bg-bg text-ink py-8 px-5">
        <div className="max-w-sm mx-auto">
          ...
          {/* UPI instructions */}
          <div className="bg-c2 border-[1.5px] border-ink mt-4 p-4">
            <div className="font-mono text-[10px] uppercase tracking-[0.1em] mb-3">Pay entry fee via UPI</div>
            ...
            <p className="font-body text-[14px] mt-3 leading-relaxed text-pretty">
              Transfer the event fee to our UPI ID. <strong>Do not upload a screenshot</strong> — we verify within 24h and activate your ticket via WhatsApp.
            </p>
            <div className="mt-3 font-mono text-[13px] font-bold break-all">
              ngo.aquaterra@upi
            </div>
      ...
      <div id="print-root" className="w-full max-w-[420px] mx-auto p-6">
        ...
        >
          <div className="bg-ink text-bg p-3 px-5 flex justify-between items-baseline">
            ...
            <span className="font-mono text-[10px] tracking-[0.16em] opacity-80">2026 · JUN 3–7</span>
          </div>
