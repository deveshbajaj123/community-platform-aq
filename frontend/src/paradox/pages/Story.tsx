...
const TAGLINES: Record<string, string> = {
  cricket:        'Bat, ball, and full commitment. Cricket at Paradox 2026. May the best team win. 🏏🏆',
  football:       'Pitch booked. Boots on. Football at Paradox 2026 — see you on the pitch. ⚽🔥',
  debate:         'Taking the floor. Debate at Paradox 2026. Come change my mind. 🌐🎙️',
  quiz:           'Trivia ready. Quiz at Paradox 2026 — bring your sharpest squad. 🧠⚡',
  painting:       'My canvas. My story. Painting at Paradox 2026. ✨🎨',
  photography:    'My lens. My story. Photography at Paradox 2026. 📸✨',
  dance:          'Stage set. Music on. Dance Showcase at Paradox 2026. Watch us move. 💃🔥',
  music:          'Plug in. Tune up. Music at Paradox 2026 — hear us live. 🎸🔊',
  'science-fair': 'Built it. Tested it. Science Fair at Paradox 2026. 🔬⚙️',
  'biz-plan':     'Pitching my idea to the sharks at Paradox 2026. Got a better one? Come prove it. 💼🦈',
  gaming:         'Controller loaded. Bracket incoming. Gaming at Paradox 2026. 🎮⚡',
  finale:         'See you at the Grand Finale. Paradox 2026. The best of the best. 🏆',
  afterparty:     'See you at the After Party. Paradox 2026 — the night to remember. 🪩🎶',
}
...
export function StoryPage() {
  ...
  useEffect(() => {
    ...
    const tagline = TAGLINES[eventSlug] ?? `See you at Paradox 2026. June 3–7. 🔥`
    ...
    ctx.fillText('PARADOX ★ 2026', W / 2, 90)
    ...
    ctx.textAlign = 'center'
    ctx.fillText('JUN 3–7 · KOLKATA', 0, 0)
    ctx.restore()
        ...
        >
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-3 font-body text-[15px] text-ink bg-bg border-[1.5px] border-ink outline-none cursor-pointer focus:shadow-[3px_3px_0_#181818] transition-shadow"
            >
          ...
          <div>
            ...
            <input
              ...
              placeholder="riya"
              className="w-full px-3.5 py-3 font-body text-[15px] text-ink bg-bg border-[1.5px] border-ink outline-none focus:shadow-[3px_3px_0_#181818] transition-shadow"
            />
